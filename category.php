    ...
    <div class="relative z-10 container mx-auto px-4 py-16 flex items-center">
        <div>
            <nav class="text-gray-400 text-sm mb-2 flex items-center gap-2">
                <a href="<?php echo SITE_URL; ?>" class="hover:text-green-400">হোম</a>
                <span>/</span>
            ...
            <p class="text-gray-300"><?php echo count($products); ?> টি পণ্য পাওয়া গেছে</p>
        </div>
    </div>
</div>
...
<section class="py-12">
    <div class="container mx-auto px-4">
        ...
        <div class="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-gray-200">
            ...
            <h2 class="text-xl font-bold text-gray-800 mb-2">এখনো কোন পণ্য নেই</h2>
            <p class="text-gray-500">আমরা শীঘ্রই এই ক্যাটাগরিতে পণ্য যোগ করব। অনুগ্রহ করে আবার ভিজিট করুন।</p>
            <a href="<?php echo SITE_URL; ?>" class="mt-6 inline-block bg-green-600 text-white font-bold px-6 py-3 rounded-xl hover:bg-green-700 transition">হোম পেজে ফিরে যান</a>
        </div>
        <?php else: ?>
